...
- `test/scry/test/search/conn_test.exs` -- confirms `articles/0` returns a real, working conn, running the lang_spec.md §8.5 worked example against it for real; `test/mix/tasks/scry.query_test.exs` -- a smoke test that the configured Mix tasks work end to end.
